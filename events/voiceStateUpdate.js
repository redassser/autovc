...
module.exports = (client, oldmember, newmember) => {
    if(!newmember.guild.members.cache.get(client.user.id).hasPermission("MANAGE_CHANNELS")) {newmember.member.send("Sorry! I don't have the ``manage channels`` permission in "+message.guild.name+"!");return;}
