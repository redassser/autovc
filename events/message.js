module.exports = (client, message) => {
    ...
    if(possCommands.includes(message.content.toLowerCase())) {
        ...
        if(!message.guild.members.cache.get(client.user.id).hasPermission("MANAGE_CHANNELS")) {message.channel.send("Sorry! I don't have the ``manage channels`` permission in "+message.guild.name+"!");return;}
